        ...
        <form action="" method="POST">
            ...
            <div class="grup-input-last">
                <div class="grup-input">
                    ...
                    <input type="number" name="jml_peserta_didik" class="input-cs" id="" placeholder="Masukan Jumlah Peserta Didik">
                </div>
            ...
            <?php 
                ...
                if(isset($_POST['submit'])) {
                    ...
                    // Store data in the students array
                    ...
                    if (!empty($students)) {
                        ...
                        echo '<tr><th>NIS</th><th>Nama</th><th>Nilai</th></tr>';
